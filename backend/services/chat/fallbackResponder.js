...
export const STATIC = {
  English:
    ...
    "or reach us at support@swadkart.com. We apologize for the inconvenience!",
  ...
  Hindi:
    ...
    "या support@swadkart.com पर हमसे संपर्क कर सकते हैं। असुविधा के लिए खेद है!",
  ...
  Hinglish:
    ...
    "ya humein mail karo support@swadkart.com pe. Inconvenience ke liye maafi!",
  ...
  Tamil:
    ...
    "/cart இல் உங்கள் கார்ட்டைச் சரிபாருங்கள், அல்லது support@swadkart.com இல் எங்களைத் தொடர்பு கொள்ளுங்கள்.",
  ...
  Telugu:
    ...
    "/cart లో మీ కార్ట్ తనిఖీ చేయండి, లేదా support@swadkart.com కు మాకు మెయిల్ చేయండి.",
  ...
  Bengali:
    ...
    "অথবা support@swadkart.com এ আমাদের সাথে যোগাযোগ করুন।",
  ...
  Marathi:
    ...
    "किंवा support@swadkart.com वर आम्हाला संपर्क करा. गैरसोयीबद्दल क्षमस्व!",
};
