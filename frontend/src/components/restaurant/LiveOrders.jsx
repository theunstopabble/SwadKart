...
const LiveOrders = ({
 ...
 <div className="bg-green-500/10 border border-green-500/20 p-3 rounded-xl text-green-400 text-xs text-center font-bold flex items-center justify-center gap-2">
