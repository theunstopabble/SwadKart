...
const ItemModal = ({
 ...
 <h2 className="text-3xl font-black uppercase tracking-tighter text-white mb-8 border-l-4 border-primary pl-4">
 ...
 <input
 type="number"
 className="w-full bg-black border border-gray-800 rounded-2xl p-4 text-sm text-white focus:border-primary outline-none transition-all font-black placeholder-gray-700"
 placeholder="299"
 value={newItem.price}
 onChange={(e) =>
