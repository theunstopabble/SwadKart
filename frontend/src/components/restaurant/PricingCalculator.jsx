      ...
      <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400">Calculate margins, tier pricing, and platform fees</p>
          </div>
        </div>
        ...
        >
          {loading ? "Calculating..." : "Calculate Pricing Tiers"}
        </button>
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">Platform fees across all restaurants</p>
            </div>
          </div>
          <button
