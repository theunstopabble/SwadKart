...
const CouponSection = ({
 ...
 className="w-full bg-black text-white pl-10 pr-10 py-3 rounded-xl border border-gray-800 focus:border-primary outline-none uppercase font-black tracking-tighter text-sm transition-all placeholder:text-gray-700"
 value={couponCode}
 ...
 <div className="text-[8px] font-black bg-green-500/10 text-green-500 px-2 py-1 rounded-full uppercase border border-green-500/20">
 Tap to Apply
 </div>
 </div>
 ))}
