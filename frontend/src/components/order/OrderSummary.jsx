...
const OrderSummary = ({
 ...
 <div>
 <h2 className="text-2xl font-extrabold uppercase tracking-tighter text-white leading-none">
 ...
 <span className="text-4xl font-extrabold text-primary tracking-tighter drop-shadow-xl">
 ₹{totalPrice ?? 0}
 </span>
 </div>
