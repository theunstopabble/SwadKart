    ...
    <div className="bg-gray-900 border border-gray-800 rounded-[1.5rem] sm:rounded-[2rem] p-4 sm:p-6 hover:border-primary/50 transition-all shadow-xl group relative overflow-hidden">
      ...
      <div className="flex justify-between items-start gap-2 mb-4 sm:mb-6">
        <div className="min-w-0">
          ...
          <h3 className="text-base sm:text-lg font-black text-white italic tracking-tighter uppercase truncate">
      ...
      <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
        <div className="flex items-start gap-2 sm:gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[9px] sm:text-[10px] text-gray-500 font-bold leading-relaxed italic line-clamp-2">
      ...
      <div className="pt-4 sm:pt-6 border-t border-gray-800">
        <div className="flex justify-between items-center mb-3 sm:mb-4">
          <div>
            ...
            <p className="text-lg sm:text-xl font-black text-white italic tracking-tighter flex items-center gap-2 flex-wrap">
              ₹{order.totalPrice || 0}
