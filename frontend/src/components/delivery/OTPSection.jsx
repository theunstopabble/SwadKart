    ...
    <div className="bg-black/30 p-4 rounded-xl border border-gray-700 mt-4">
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          className="flex-1 bg-blue-600 hover:bg-blue-500 text-white font-bold py-2 px-4 rounded-lg shadow-lg transition-transform active:scale-95 text-sm disabled:opacity-50 disabled:cursor-not-allowed"
        >
