...
const RestaurantMenu = () => {
 ...
 <p className="text-gray-500 font-extrabold tracking-widest text-xs uppercase">
 Loading Menu...
 </p>
 </div>
 );
 ...
 <p className="text-gray-500 text-lg font-extrabold uppercase tracking-widest">
 ...
 <h2 className="text-2xl font-extrabold uppercase text-white mb-8 border-l-4 border-primary pl-4 flex items-center gap-3">
 {category}{" "}
 ...
 <h3 className="text-xl font-extrabold uppercase text-white group-hover:text-primary transition-colors leading-none">
{item.name || "Dish"}
 </h3>
 ...
 <p className="text-gray-500 text-xs font-bold mb-6 line-clamp-2 leading-relaxed">
 {item.description}
 </p>
 <button
 ...
 <div>
 <h3 className="text-2xl font-extrabold uppercase text-white leading-none mb-1">
 {selectedItem.name}
 </h3>
