          ...
          <form onSubmit={verifyOtpHandler} className="mt-8 space-y-6">
            <div className="relative">
              ...
              <input
                ...
                pattern="[0-9]{6}"
                placeholder="• • • • • •"
                className="block w-full pl-12 pr-4 py-4 bg-black/50 border border-primary/50 rounded-xl text-center text-white text-xl sm:text-2xl font-black tracking-[0.3em] sm:tracking-[0.5em] focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all placeholder-gray-700"
                value={otp}
