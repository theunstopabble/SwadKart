...
const OrderDetails = () => {
 ...
 <div className="bg-gray-900 border border-gray-800 px-8 py-3 rounded-2xl text-lg font-black text-white shadow-xl">
 {order.orderStatus}
 </div>
 {/* 🛡️ Cancel Order Button */}
 {(order.orderStatus === "Payment Pending" || order.orderStatus === "Placed" || order.orderStatus === "Preparing") && (
 <button
 onClick={async () => {
 ...
 const url = isPending
 ? `${BASEURL}/api/v1/orders/${order._id}/cancel-pending`
 : `${BASEURL}/api/v1/orders/${order._id}/cancel`;
 ...
 >
 {order.orderStatus === "Payment Pending" ? "Cancel & Delete" : "Cancel Order"}
 </button>
 )}
 {/* ⏰ FEAT-12: ETA Display */}
 ...
 <h3 className="text-white font-black uppercase tracking-widest text-xl mb-2">
 ...
 <p className="font-black text-xl uppercase tracking-tight text-white mb-1">
 ...
 <h3 className="font-black uppercase tracking-tighter text-3xl text-white">
 ...
 <h2 className="text-lg font-black uppercase tracking-tighter border-b border-gray-900 pb-4 text-white">
 Financials
 </h2>
