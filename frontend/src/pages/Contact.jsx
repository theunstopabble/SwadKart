...
const Contact = () => {
 ...
 <p className="text-gray-500 max-w-2xl mx-auto font-medium text-sm md:text-base leading-relaxed ">
 ...
 <h2 className="text-3xl font-extrabold uppercase tracking-tighter mb-8 flex items-center gap-3">
