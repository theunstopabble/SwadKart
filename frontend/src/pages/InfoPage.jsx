...
const InfoPage = () => {
 ...
 <h2 className="text-3xl font-extrabold text-primary uppercase tracking-tighter mb-4">
 404 - Page Not Found
 </h2>
 <Link
 to="/"
 ...
 <h1 className="text-4xl md:text-5xl font-extrabold uppercase tracking-tighter text-white">
 {data.title}
 </h1>
 ...
 <p className="text-xl text-gray-300 leading-relaxed mb-10 border-l-4 border-primary pl-6 font-medium ">
 {data.text}
 </p>
 ...
 <span className="text-primary ">Q.</span> {q.q}
 </h3>
