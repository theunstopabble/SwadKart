...
const MyOrders = () => {
 ...
 <div>
 <h1 className="text-3xl sm:text-5xl font-extrabold uppercase tracking-tighter flex items-center gap-4">
 ...
 />
 <div>
 <p className="text-sm font-extrabold uppercase tracking-tight text-gray-200">
 ...
 <span className="font-mono text-sm font-extrabold tracking-tighter text-white">
