...
const PlaceOrder = () => {
 ...
 <div>
 <p className="text-xs font-extrabold text-blue-400 uppercase tracking-[0.2em] ">
 ...
 <h2 className="text-2xl font-extrabold uppercase tracking-tighter text-white">
 ...
 <Link
 to="/cart"
 className="mt-8 inline-flex items-center gap-2 text-[10px] font-extrabold text-gray-500 hover:text-primary uppercase tracking-[0.3em] transition-all border-b border-gray-800 pb-1"
 >
