...
const DeliveryPartnerDashboard = () => {
 ...
 <h1 className="text-2xl sm:text-3xl md:text-5xl font-extrabold uppercase tracking-tighter leading-none break-words">
 ...
 <h3 className="text-lg sm:text-2xl font-extrabold uppercase tracking-tighter text-white">
 ...
 <p className="text-gray-500 font-extrabold uppercase text-[9px] sm:text-[10px] tracking-[0.3em] sm:tracking-[0.4em] px-4">
